...
import { ShieldCheck, ShieldAlert, Check, X, KeyRound } from "lucide-react";
 ...
 * on-chain commits to EXACTLY the terms they agreed. Anomalies (mismatches)
 * are shown as red flags, so nothing on-chain can be silently altered.
 */
export function ContractVerifier({ state, myRole }: Props) {
